"""
PlagioVeritas — Premium Gemini-style Streamlit App.
...
# ---------- Page config ----------
st.set_page_config(
    page_title="PlagioVeritas · Academic Integrity Engine",
    page_icon="🛡️",
    layout="wide",
...
<div class="hero-container">
    ...
    <h1 class="hero-title">PlagioVeritas</h1>
...
<html><head><meta charset="utf-8"><title>PlagioVeritas Report</title>
<style>
...
<h1>🛡️ PlagioVeritas Integrity Report</h1>
...
<hr><p><i>Generated by PlagioVeritas v{__version__}</i></p>
</body></html>"""
...
st.markdown(
    ...
    '🛡️ <b>PlagioVeritas</b> v' + __version__ + ' — '
